                        ...
                        <div class="col-md-6 col-lg-4">
                            ...
                            <div class="project-card-no-image" style="border-top: 4px solid red !important;">
                                ...
                                <div class="tags">
                                    ...
                                    <c:if test="${resource.status != 'disabled'}">
                                        <a href="/apimetadata?id=<c:out value='${criptomoneda.acronimo}'/>" class="btn btn-error btn-sm float-right" role="button"><i class="fas fa-search" style="color: white;"></i></a>
