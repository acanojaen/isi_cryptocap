                ...
                <div class="item">
                    ...
                    <div class="row">
                        <div class="col-md-6"><p class="text-muted">Consultamos la API en las siguientes operaciones:
                            <ul>
                                <li>Conversor <span class="badge badge-secondary">https://coinmarketcap.com/api/documentation/v1/#operation/getV1ToolsPriceconversion</span> <a href="/compare" class="btn btn-warning btn-sm" role="button"><i class="fas fa-play"></i></a></li>
                                <li>Obtener métricas de mercado <span class="badge badge-secondary">https://coinmarketcap.com/api/documentation/v1/#operation/getV1GlobalmetricsQuotesLatest</span> <button class="btn btn-warning btn-sm" data-target="#api_prices" data-toggle="modal" type="button" data-whatever="investing.com"><i class="fas fa-play"></i></button></li>
