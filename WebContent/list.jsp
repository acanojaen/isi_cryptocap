                    ...
                    <div class="item">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                    ...
                                    <a href="/ficha?id=<c:out value='${criptomoneda.acronimo}'/>&entity=criptomoneda" class="btn btn-warning btn-sm float-right" role="button" target="_blank"><i class="fas fa-eye"></i></a>
                            </div>
                        </div>
                    </div>
                  </c:forEach>
