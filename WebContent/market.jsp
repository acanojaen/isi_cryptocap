                ...
                <table class="table">
                    ...
                    <c:forEach items="${criptos}" var="c">
                        <tr>
                            ...
                            <td>
                                <fmt:formatNumber type="number" maxFractionDigits="2" value="${c.variacion24}"/>%
                            </td>
                            <td>
                                <fmt:formatNumber type="number" maxFractionDigits="2" value="${c.variacion7}"/>%
                            </td>
                            <td>
                                <fmt:formatNumber type="number" maxFractionDigits="2" value="${c.variacion30}"/>%
                            </td>
